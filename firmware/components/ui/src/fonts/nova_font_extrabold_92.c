...
#ifndef NOVA_FONT_EXTRABOLD_92
#define NOVA_FONT_EXTRABOLD_92 1
#endif

#if NOVA_FONT_EXTRABOLD_92
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1157, .box_w = 76, .box_h = 65, .ofs_x = -2, .ofs_y = 0},
    {.bitmap_index = 2470, .adv_w = 428, .box_w = 0, .box_h = 0, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2470, .adv_w = 1157, .box_w = 76, .box_h = 84, .ofs_x = -2, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t nova_font_extrabold_92 = {
#else
lv_font_t nova_font_extrabold_92 = {
#endif
...
#endif /*#if NOVA_FONT_EXTRABOLD_92*/
