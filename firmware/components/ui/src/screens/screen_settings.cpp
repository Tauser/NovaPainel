...
void np_screen_settings(lv_obj_t* parent)
{
    ...
    slider_row(disp, "Brilho da tela", 78);
    np_label(disp, "VOLUME", NP_F_XS, NP_C_TEXT_DARK);
    slider_row(disp, "Sistema", 65);
    ...
    lv_obj_t* night_toggle = np_toggle(night_row, false);
    lv_obj_add_state(night_toggle, LV_STATE_DISABLED);
    ...
    lv_obj_add_state(reboot_btn, LV_STATE_DISABLED);
